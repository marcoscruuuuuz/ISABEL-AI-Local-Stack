...
from app.routers import agent, chat, research, admin, billing, multi_agent
...
app = FastAPI(
    ...
    description="Chat + Deep Research + Agent + Commercial Multi-tenant",
)
...
async def list_models(authorization: str | None = Header(default=None)):
    ...
    return {
        "object": "list",
        "data": [
            {"id": settings.llm_model, "object": "model", "owned_by": "isabel"},
        ],
    }
